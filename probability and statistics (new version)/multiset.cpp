...
template<typename DataType>
bool multiset<DataType>::intersection_tour(node<DataType>*src_tree_ptr,const bst<DataType>*other_tree,
...
template<typename DataType>
bool multiset<DataType>::union_tour(node<DataType>*src_tree_ptr,const bst<DataType>*other_tree,
					   	 node<DataType>**match_vector,uint32_t& match_counter)const{
	if(src_tree_ptr&&other_tree){
		if(src_tree_ptr->left){
...
template<typename DataType>
bool multiset<DataType>::unique_elements_tour(node<DataType>*src_tree_ptr,const bst<DataType>*other_tree,
					   	 node<DataType>**match_vector,uint32_t& match_counter)const {
	if(src_tree_ptr&&other_tree){
		if(src_tree_ptr->left){
	...
	template<typename DataType>
	bool multiset<DataType>::difference_tour(node<DataType>*src_tree_ptr,const bst<DataType>*other_tree,
						   	 node<DataType>**match_vector,uint32_t& match_counter)const {
		if(src_tree_ptr&&other_tree){
			if(src_tree_ptr->left){
	...
	multiset <DataType> multiset<DataType>:: intersect(const multiset&src_mset) const{
		if(tree.nodes_count&&src_mset.tree.nodes_count){
			node<DataType>**match_vector = new node<DataType>*[(src_mset.tree.nodes_count <tree.nodes_count)?src_mset.tree.nodes_count:tree.nodes_count] ;
	...
	template<typename DataType>
	multiset<DataType> multiset<DataType>::form_tree(node<DataType>**vec,uint32_t size)const{
		if(vec&&size){
			multiset<DataType>ret_set ;
			uint32_t start = 0;
	...
	template<typename DataType>
	bool multiset<DataType>::merge(node<DataType>**dest, node<DataType>**vec1, node<DataType>**vec2 ,
	...
	template<typename DataType>
	bool multiset<DataType>::contain_tour(node<DataType>*src_tree_ptr,const bst<DataType>*other_tree,
	...
	template<typename DataType>
	bool multiset<DataType>::equality_tour(node<DataType>*src_tree_ptr,const bst<DataType>*other_tree,
						   	 			  uint32_t& match_counter)const {
		if(src_tree_ptr&&other_tree){
			if(src_tree_ptr->left){
	...
	template<typename DataType>
	bool multiset<DataType>::avg_tour(node<DataType>*src_tree_ptr,DataType& match_counter)const {
		if(src_tree_ptr){
			if(src_tree_ptr->left){
	...
	template<typename DataType>
	bool multiset<DataType>::powered_avg_tour(node<DataType>*src_tree_ptr,DataType& match_counter,double power)const {
		if(src_tree_ptr){
			if(src_tree_ptr->left){
	...
	//E[x^2]-E[x]
	template<typename DataType>
	bool  multiset<DataType>::variance_tour(node<DataType>*src_tree_ptr,DataType& avg1,DataType&avg2)const{
		if(src_tree_ptr){
			if(src_tree_ptr->left){
	...
	template<typename DataType>
	bool multiset<DataType>::mode_tour(node<DataType>*src_tree_ptr,const node<DataType>*&mode_ptr)const {
		if(src_tree_ptr){
			if(src_tree_ptr->left){
	...
	template<typename DataType>
	bool multiset<DataType>::pmf_tour(node<DataType>*src_tree_ptr,std::vector<double>&pmf_vec,uint32_t &counter)const {
		if(src_tree_ptr){
			if(src_tree_ptr->left){
	...
	template<typename DataType>
	bool multiset<DataType>::cmf_tour(node<DataType>*src_tree_ptr,std::vector<double>&cmf_vec,uint32_t &counter)const {
		if(src_tree_ptr){
			if(src_tree_ptr->left){
	...
	template<typename DataType>
	void multiset<DataType>::apply_function_tour(node<DataType>*src_tree_ptr,bool(*f_ptr)(DataType&,uint32_t&,
	...
	template<typename DataType>
	bool multiset<DataType>::draw_no_replace_tour(node<DataType>*src_tree_ptr,const bst<DataType>*sample_space,
	...
	template<typename DataType>
	bool multiset<DataType>::draw_replace_tour(node<DataType>*src_tree_ptr,const bst<DataType>*sample_space,
				     	long double&p)const{
		if(src_tree_ptr&&sample_space){
			if(src_tree_ptr->left){
